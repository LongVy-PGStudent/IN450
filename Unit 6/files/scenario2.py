"""
Dressing Room Simulation - Scenario 2
20 customers, 5 dressing rooms, random items
"""
...
class Customer(threading.Thread):
    """Represents a customer trying clothing items."""
...
class Scenario:
    ...
    def run(self):
        print(f"\n{'='*60}")
        print(f"SCENARIO 2: {self.num_customers} customers, {self.num_rooms} rooms, "
...
def scenario2():
    ...
    print("Using preset values for Scenario 2\n")
